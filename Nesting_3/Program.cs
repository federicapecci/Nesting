...
namespace Nesting_3
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Configuration configuration = jsonConfigurationIO.ReadAllData("3_hsolve_configuration_temp19");
            ...
            dxfDrawer.WriteAllData(sequences, "output_3_hsolve_output_temp19");
